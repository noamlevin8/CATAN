...
int main()
{
    ...
    p1.placeSettelement(places, placesNum, board);
    ...
    p2.placeSettelement(places, placesNum, board);
    p2.placeRoad(places, placesNum, board);
    try
    {
        p3.placeSettelement(places, placesNum, board); // p3 tries to place a settlement in the same location as p2.
    }
    ...
    p3.placeSettelement(places, placesNum, board);
